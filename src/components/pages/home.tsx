...
export default function HomePage() {
  ...
  return (
    <div className="px-4">
      {/* HERO SECTION */}
      <section className="relative w-full h-[300px] md:h-[420px] overflow-hidden rounded-3xl mt-6">
      ...
      <section className="mt-14 max-w-7xl mx-auto ">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-9">
          {categories.map((cat, idx) => (
            <div
              key={idx}
              className="relative shadow-2xl w-44 aspect-square rounded-4xl cursor-pointer overflow-hidden  hover:shadow-lg transition-all"
              style={{
...
<section className="mt-28">
  ...
  {/* BACKGROUND WRAPPER */}
  <div className="max-w-7xl mx-auto relative bg-[#d18893] rounded-[40px] 
      pt-6 pb-6 px-6">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8
      ...
      {products.map((p) => (
        ...
        >
          ...
          {/* DARK GRADIENT */}
          <div className="absolute bottom-0 w-full h-40 bg-gradient-to-t 
            ...
            <button className="mt-2 bg-white text-black px-4 py-1 rounded-full 
